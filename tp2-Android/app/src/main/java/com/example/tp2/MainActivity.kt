...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var studentsCours = arrayListOf<Student>(
            Student("samir", "hamda", GenderEnum.male, StatusEnum.present),
            Student("Ons", "maaref", GenderEnum.female, StatusEnum.absent)
        )
        var studentsTp = arrayListOf<Student>(
            Student("Ala", "hamroun", GenderEnum.male, StatusEnum.absent),
            Student("Sara", "seddik", GenderEnum.female, StatusEnum.present)
        )
